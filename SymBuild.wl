...
Print["Version 0.40, July 28, 2018 "]
...
(*!!!!!! REDO THE DESCRIPTION *)
computeTheIntegrabilityTensor::usage="The command 'computeTheIntegrabilityTensor[alphabet_,allvariables_,listOfRoots_,listOfRootPowers_,sampleSize_,maxSamplePoints_,toleranceForRetries_]' 
computes the integrability tensor \[DoubleStruckCapitalF] for a given alphabet 'alphabet_' in the variables 'allvariables_'.
The array 'listOfRoots_' contains a list of rational functions {\[CapitalDelta]1, ..., \[CapitalDelta]s} such that the roots \[Rho]i obey \[Rho]i^{ni}=\[CapitalDelta]i, where the powers ni are contained in the array 'listOfRootPowers_'. 
...
Flatten[transposeLevelsSparseArray[SparseArray[eqnMatrix],{3,1,2}],1]
];
